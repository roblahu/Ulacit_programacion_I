...
public class BLL_Estudiantes {
    ...
    public boolean InsertarEstudiante(String nombre, String primer_apellido, String segundo_apellido, String cedula, String fecha_nacimiento,String telefono, String correo,String nombre_madre, String primer_apellido_madre, String segundo_apellido_madre, String nombre_padre, String primer_apellido_padre, String segundo_apellido_padre) throws SQLException, ClassNotFoundException {
        boolean result = false;
        if (nombre == "") {
            return result;
        } else {
            DAL.insertEstudiante(nombre, primer_apellido,segundo_apellido,cedula,fecha_nacimiento,telefono,correo,nombre_madre,primer_apellido_madre,segundo_apellido_madre,nombre_padre,primer_apellido_padre,segundo_apellido_padre);
            result = true;
        }
        return result;
    }
